                ...
                <div class="x_content">
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('financial/store_invoice') ?>">
                        <div class="form-group row">
                            ...
                            <div class="col-md-3 col-xs-12 mt-2" style="display: none">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-xs-12 text-right">
                                <div class="mt-5">
                                    ...
                                    <input type="checkbox" class="" style="margin-left: 0px; display: none" name="opsi_pph" id="opsi_pph" value="1" disabled checked>
